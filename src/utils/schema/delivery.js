...
// 交付流程
  delivery: {
    ...
    updateDocuments: `mutation($ds: [InputDocument]) {
		updateDocuments(ds: $ds)
			{
			id
			taskId
			name
    ...
    uploadAutograph: `mutation($base64: String) {
		uploadAutograph(base64: $base64)
	}`, // 上传base64签名返回签名图片地址
    ...
    getStakeholderCompanyList: `query($projectId: String) {
		getStakeholderCompanyList(projectId: $projectId)
			{
			id
			name
		}
